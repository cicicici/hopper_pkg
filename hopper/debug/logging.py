...
from hopper.debug import DbgLvl as DL
from hopper.debug import DbgChn as DC
from hopper.debug import dbg_vld as DV
...
class Logger(object):
    ...
    def log_pp(self, *args, **kwargs):
        hp.print_pp(*args, **kwargs)


_logger_std = Logger(None)
_logger = logging.getLogger('hopper')
